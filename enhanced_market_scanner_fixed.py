...
from everef_market_client_fixed import EVERefMarketClient
...
class EnhancedMarketScanner:
    ...
    def fetch_ship_orders(self, ship_type='battleship') -> Dict[int, List[Dict]]:
        ...
        if self.use_everef and self.everef_client:
            ...
            if os.path.exists(market_orders_dir) and any(f.endswith('_processed.csv') for f in os.listdir(market_orders_dir)):
