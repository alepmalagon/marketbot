...
class EVERefMarketClient:
    ...
    def __init__(self, data_dir="everef_data"):
        ...
        if not os.path.exists(self.market_orders_dir):
            ...
            logger.warning("Please run everef_market_data_downloader_fixed.py to download market data")
    ...
    def _get_latest_market_orders_file(self) -> Optional[str]:
        ...
        if raw_files:
            ...
            logger.warning("This will be slower. Consider running everef_market_data_downloader_fixed.py to process the data.")
            return raw_files[0]
